...
async def get_role(role_id: int, db: AsyncSession = Depends(get_async_session)):
    repository = RoleRepository(db)
...
async def update_role(role_id: int, role: RoleCreate, db: AsyncSession = Depends(get_async_session)):
    repository = RoleRepository(db)
...
async def deactivate_role(role_id: int, db: AsyncSession = Depends(get_async_session)):
    repository = RoleRepository(db)
