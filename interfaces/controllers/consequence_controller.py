...
async def read_consequence_endpoint(consequence_id: int, db: AsyncSession = Depends(get_async_session)):
    repository = ConsequenceRepository(db)
...
async def read_all_consequence_endpoint(db: AsyncSession = Depends(get_async_session)):
    repository = ConsequenceRepository(db)
...
async def update_consequence_endpoint(consequence_id: int, consequence: ConsequenceCreate, db: AsyncSession = Depends(get_async_session)):
    repository = ConsequenceRepository(db)
