...
class RiskControlTypeRepository:
    ...
    async def create_risk_control_type(self, control_type: RiskControlTypesEntity) -> RiskControlTypesEntity:
        ...
        try:
            ...
            row = result.fetchone()
            if row:
                return RiskControlTypesEntity(id=row.id, description=row.description)
    ...
    async def get_risk_control_type(self, control_type_id: int) -> Optional[RiskControlTypesEntity]:
        ...
        if control_type:
            return RiskControlTypesEntity(id=control_type.id, description=control_type.description)
        return None
    ...
    async def get_all_risk_control_types(self) -> List[RiskControlTypesEntity]:
        ...
        return [RiskControlTypesEntity(id=ct.id, description=ct.description) for ct in control_types]
